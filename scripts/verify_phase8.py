    ...
    gates = {
        "ci_enforces_phase8_gate": (
            (
                ...
                or "make phase13-verify" in ci_workflow
                or "make release-verify" in ci_workflow
            )
        ...
        "deploy_preflight_enforces_phase8_gate": (
            (
                ...
                or "make phase13-verify" in deploy_workflow
                or "make release-verify" in deploy_workflow
            )
